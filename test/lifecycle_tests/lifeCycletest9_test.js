...
//ongoing - need to merge funding utxos 
  it('Full Life Cycle Test 10 - Issuance with 10mb of data', async function () {
    ...
    const fundingUtxos3 = await getFundsFromFaucet(fundingPrivateKey.toAddress(process.env.NETWORK).toString())
