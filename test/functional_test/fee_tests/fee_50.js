...
it("Full Life Cycle Test With Fees 50 sats/Kb", async () => {
  ...
  expect(contractFees).to.be.above(66).and.to.be.below(74);
  ...
  expect(issueFees).to.be.above(160).and.to.below(166);
  ...
  expect(transferFees).to.be.above(172).and.to.below(182);
  ...
  expect(splitFees).to.be.above(245).and.to.be.below(255);
  ...
  expect(mergeFees).to.be.above(400).and.to.be.below(410);
  ...
  expect(mergeSplitFees).to.be.above(470).and.to.be.below(480);
  ...
  expect(redeemFees).to.be.above(100).and.to.be.below(110);
});
