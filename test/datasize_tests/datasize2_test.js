...
it('Symbol 128 Data Size Zero Bytes', async () => {
  const data = ''
...
it('Symbol 128 Data Size 1 Byte', async () => {
  const data = 'A'
  console.log('Data Size ' + utils.byteCount(data))
  const issueInfo = [
    {
...
it('Symbol 128 Data Size < 75 Bytes', async () => {
...
it('Symbol 128 Data Size < 128 Bytes', async () => {
...
it('Symbol 128 Data Size > 32768 Bytes', async () => {
