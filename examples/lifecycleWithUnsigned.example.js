...
;(async () => {
  ...
  try {
    unsignedIssueRes = await unsignedIssue(
      ...
      issueInfo,
      {
        ...
        amount: newContractTx.vout[0].value
      },
      {
        txid: contractTxid,
        vout: 1,
        scriptPubKey: newContractTx.vout[1].scriptPubKey.hex,
        amount: newContractTx.vout[1].value
      },
      fundingPublicKey,
      true, // isSplittable
      symbol
  ...
  const unsignedTransferRes = await unsignedTransfer(
    bobPublicKey,
    {
      ...
      amount: newIssueTx.vout[1].value
    },
    aliceAddr,
    {
      txid: issueTxid,
      ...
      amount: newIssueTx.vout[issueOutFundingVout].value
    },
    fundingPublicKey
  )
  ...
  const unsignedSplitRes = await unsignedSplit(
    alicePublicKey,
    {
      ...
      amount: newTransferTx.vout[0].value
    },
    splitDestinations,
    {
      txid: transferTxid,
      ...
      amount: newTransferTx.vout[1].value
    },
    fundingPublicKey
  )
  ...
  const unsignedMergeRes = await unsignedMerge(
    ...
    aliceAddr,
    {
      ...
      amount: newSplitTx.vout[2].value
    },
    fundingPublicKey
  )
  ...
  const unsignedSplitRes2 = await unsignedSplit(
    alicePublicKey,
    {
      ...
      amount: newMergeTx.vout[0].value
    },
    split2Destinations,
    {
      txid: mergeTxid,
      ...
      amount: newMergeTx.vout[1].value
    },
    fundingPublicKey
  ...
  const unsignedMergeSplitRes = await unsignedMergeSplit(
    ...
    [{
      ...
      vout: 0,
      amount: newSplitTx2.vout[0].value
    },
    {
      tx: splitTx2,
      scriptPubKey: newSplitTx2.vout[1].scriptPubKey.hex,
      vout: 1,
      amount: newSplitTx2.vout[1].value
    ...
    bobAmountSatoshis,
    {
      ...
      amount: newSplitTx2.vout[2].value
    },
    fundingPublicKey
  )
  ...
  const unsignedRedeemRes = await unsignedRedeem(
    ...
    issuerPrivateKey.publicKey,
    {
      ...
      amount: newMergeSplitTx.vout[0].value
    },
    {
      txid: mergeSplitTxid,
      vout: 2,
      scriptPubKey: newMergeSplitTx.vout[2].scriptPubKey.hex,
      amount: newMergeSplitTx.vout[2].value
    },
    fundingPublicKey
  )
  ...
  const unsignedRedeemSplitRes = await unsignedRedeemSplit(
    ...
    issuerPrivateKey.publicKey,
    {
      ...
      amount: newMergeSplitTx.vout[1].value
    },
    redeemSplitDestinations,
    {
      ...
      amount: newRedeemTx.vout[1].value
    },
    fundingPublicKey
  )
