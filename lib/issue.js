...
*/
function issue (privateKey, issueInfo, contractUtxo, paymentUtxo, paymentPrivateKey, isSplittable, symbol, stasType) {
  if (privateKey === null) {
  ...
  return issueWithCallback(privateKey.publicKey, issueInfo, contractUtxo, paymentUtxo, (paymentPrivateKey ? paymentPrivateKey.publicKey : null), isSplittable, symbol, ownerSignatureCallback, paymentSignatureCallback, stasType)
}
