...
*/
function issueWithCallback (publicKey, issueInfo, contractUtxo, paymentUtxo, paymentPublicKey, isSplittable, symbol, ownerSignatureCallback, paymentSignatureCallback, stasType) {
  if (publicKey === null) {
  ...
  issueInfo.forEach(is => {
    ...
    const stasScript = getStasScript(pubKeyHash, publicKey, data, isSplittable, hexSymbol, stasType)
