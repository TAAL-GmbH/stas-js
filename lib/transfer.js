...
function transfer (tokenOwnerPrivateKey, contractPublicKey, stasUtxo, destinationAddress, paymentUtxo, paymentsPrivateKey) {
  ...
  const stasScript = getStasScript(destinationPublicKey, contractPublicKey, version, getScriptData(stasUtxo.scriptPubKey, version), isSplittable(stasUtxo.scriptPubKey), getSymbol(stasUtxo.scriptPubKey))
