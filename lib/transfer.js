...
function transfer (tokenOwnerPrivateKey, contractPublicKey, stasUtxo, destinationAddress, paymentUtxos, paymentsPrivateKey) {
  ...
  const stasScript = getStasScript(destinationPublicKey, contractPublicKey, getVersion(stasUtxo.scriptPubKey), getScriptData(stasUtxo.scriptPubKey))
