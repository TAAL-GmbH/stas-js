...
*/
function createSwapOffer (makerPrivateKey, makerInputUTXO, wantedInfo, commissionInfo) {
...
function acceptSwapOffer (offerTxHex, makerInputTxHex,
  takerPrivateKey, takerInputTxHex, takerInputUTXO, takerOutputSatoshis, makerPublicKeyHash, paymentUtxo, paymentPrivateKey, commissionUtxo) {
