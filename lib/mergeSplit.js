...
function mergeSplit (tokenOwnerPrivateKey, contractPublicKey, mergeUtxos, destination1Addr, amountSatoshis1, destination2Addr, amountSatoshis2, paymentUtxo, paymentsPrivateKey) {
  ...
  const stasScript1 = getStasScript(destination1PublicKeyHash, contractPublicKey, getVersion(mergeUtxos[0].scriptPubKey))
  ...
  const stasScript2 = getStasScript(destination2PublicKeyHash, contractPublicKey, getVersion(mergeUtxos[0].scriptPubKey))
