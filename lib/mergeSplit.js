...
function mergeSplit (tokenOwnerPrivateKey, contractPublicKey, mergeUtxos, destination1Addr, amountSatoshis1, destination2Addr, amountSatoshis2, paymentUtxo, paymentPrivateKey) {
  ...
  if (!isZeroFee) {
    handleChangeForMerge(tx, extraBytesForPieces, paymentPrivateKey.publicKey)
  }
  ...
  if (!isZeroFee) {
    ...
    paymentPubKeyHash = bsv.crypto.Hash.sha256ripemd160(paymentPrivateKey.publicKey.toBuffer()).toString('hex')
  }
